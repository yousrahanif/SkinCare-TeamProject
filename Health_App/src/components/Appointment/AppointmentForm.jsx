...
//   const [appointmentDate, setAppointmentDate] = useState(new Date()); // New state for appointment date
...
//             dateFormat="MMMM d, yyyy"
//             className="w-full px-3 py-2 border border-gray-300 rounded-md"
//             minDate={new Date()} // Restrict to the current date and future dates
//             showYearDropdown
//             yearDropdownItemNumber={120}
//             scrollableYearDropdown
//             showMonthDropdown
